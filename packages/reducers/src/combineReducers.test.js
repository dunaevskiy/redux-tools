...
describe('Utils', () => {
	describe('combineReducers', () => {
		...
		it('catches error thrown in reducer when initializing and re-throw', () => {
			...
			expect(() => reducer(undefined, undefined)).toThrow(/Error thrown in reducer/);
		});
		...
		it('throws an error on first call if a reducer attempts to handle a private action', () => {
			...
			expect(() => reducer(undefined, undefined)).toThrow(/"counter".*private/);
		});
		...
		it('only warns for unexpected keys once', () => {
			...
			const bazState = Object.assign(Object.assign({}, state), { baz: 5 });
			...
			reducer(Object.assign({}, bazState), nullAction);
			reducer(Object.assign({}, bazState), nullAction);
			reducer(Object.assign({}, bazState), nullAction);
